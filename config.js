...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Her Ex Bot",
    footer: process.env.Footer || "© Powered By Her Ex Bot",
     ...
     */
    ownername: process.env.Owner_Name || "HEREXLNR",
    ownernumber: process.env.Owner_Number || "263778331068",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@EXBotz",
    packname: process.env.PackName || "Queen Anya v2 MD",
    socialLink: process.env.Web || "https://github.com/PikaBotz",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/FMUggeVSXsZIYM1PtcwojG",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "YOUR_MONGODB_URL",
    sessionId: process.env.SESSION_ID || "dmRzdDV_Queen-Anya_xeXU=",
